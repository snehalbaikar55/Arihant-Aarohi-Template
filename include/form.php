...
<select name="cf_888" data-label="label:Country+Code" class="form-control form-group" id="cc" onChange=selectedCountry1(value) style="width: 25%;  float: left;">
			...
			<input type="tel" inputmode="numeric" pattern="^[6-9]\d{9}$"  minlength="10" maxlength="16" id="india1" class="form-control rounded-0 micro-form-field" placeholder="Mobile No"  style="float: right; width: 75%;"> 
      <input type="tel" inputmode="numeric" maxlength="20" class="form-control rounded-0 micro-form-field" placeholder="Mobile No" id="ocountry1" style="float: right; width: 75%; display:none;"> 
...
<input id="myBtn" name="myRightbtn" class="btn btn-info micro-form-btn mt-2 effetMoveGradient" type="submit" value="Enquiry Now">
</form>
